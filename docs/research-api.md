...
The [0.2.2 GitHub release](https://github.com/canivel/dynolab/releases/tag/v0.2.2)
includes a Python wheel, source distribution and checksums alongside the Mac DMG.
Install the downloaded wheel with `python -m pip install mlx_dyno-0.2.2-py3-none-any.whl`.
...
matching PyPI release. The HTTP API remains `/lab/v1`; the package version is 0.2.2.
