...
Create a Python 3.10+ environment. Download the Python wheel from the [0.4.3 release assets](https://github.com/canivel/dynolab/releases/tag/v0.4.3), then install it:

```bash
python3 -m venv .venv
source .venv/bin/activate
python -m pip install ./mlx_dyno-0.4.3-py3-none-any.whl
...
```bash
python -m pip install 'mlx-dyno[serve,mcp] @ git+https://github.com/canivel/dynolab.git@v0.4.3'
```
